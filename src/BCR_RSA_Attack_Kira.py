...
from BCR_rsa_kira import generate_keys, encrypt
...
if __name__ == "__main__":
    ...
    e = 3
    N = 
    plaintext = 'C'
    #(pub_key, priv_key) = generate_keys()
    #pub_key.n = N
    #pub_key.e = e
    ciphertext = encrypt(81, N, e)
    C = ciphertext
