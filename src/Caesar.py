...
class Caesar:
    def __init__(self):
        ...
        self.freqs = {'a': 0.08167, 'n': 0.06749, 'b': 0.01492, 'o': 0.07507, 'c': 0.02782, 'p': 0.01929, 'd': 0.04253, 'q': 0.00095,
                 'e': 0.12702, 'r': 0.05987, 'f': 0.02228, 's': 0.06327, 'g': 0.02015, 't': 0.09056, 'h': 0.06094, 'u': 0.02758,
                 'i': 0.06966, 'v': 0.00978, 'j': 0.00153, 'w': 0.0236, 'k': 0.00772, 'x': 0.0015, 'l': 0.04025,
                 'y': 0.01974, 'm': 0.02406, 'z': 0.00074}
    ...
    def frequencyAttack(self, ciphertext):
        ...
        #possiblePlain = self.decryptCaesar(ciphertext, possibleKey)
        ...
        for i in allScores:
            if (start == 0):
                start = 1
                continue
            arr.append(self.decryptCaesar(ciphertext, i))
